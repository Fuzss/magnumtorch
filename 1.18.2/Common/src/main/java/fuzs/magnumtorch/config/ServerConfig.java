...
public class ServerConfig implements ConfigCore {
    ...
    public static class MagnumTorchConfig implements ConfigCore {
        ...
        List<String> mobWhitelistRaw = ConfigDataSet.toString(Registry.ENTITY_TYPE_REGISTRY);
        ...
        public void afterConfigReload() {
            ...
            this.mobBlacklist = ConfigDataSet.from(Registry.ENTITY_TYPE_REGISTRY, this.mobBlacklistRaw);
            this.mobWhitelist = ConfigDataSet.from(Registry.ENTITY_TYPE_REGISTRY, this.mobWhitelistRaw);
        }
