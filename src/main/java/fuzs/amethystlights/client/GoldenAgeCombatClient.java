package fuzs.amethystlights.client;

import fuzs.amethystlights.AmethystLights;
import fuzs.amethystlights.client.handler.*;
...
@Mod.EventBusSubscriber(modid = AmethystLights.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
