...
import fuzs.amethystlights.handler.SwordBlockingHandler;
import fuzs.amethystlights.mixin.client.accessor.ItemInHandRendererAccessor;
...
public class SwordBlockingRenderer {
    ...
    public void onRenderHand(final RenderHandEvent evt) {
        ...
        if (player.getUsedItemHand() == evt.getHand() && SwordBlockingHandler.isActiveItemStackBlocking(player)) {
            ...
            if (AmethystLights.CONFIG.client().animations.interactAnimations) {
